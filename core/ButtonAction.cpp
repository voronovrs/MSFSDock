...
void ButtonAction::UpdateVariablesAndEvents(const nlohmann::json& payload) {
    ...
    eventBindings_ = {
        ...
        { &eventWhenTrueDef_, newEventWhenTrue, (evType_ == "common") ? EVENT_GENERIC : EVENT_PMDG, (evType_ == "common") ? EVT::GENERIC : EVT::PMDG_CLICK },
        { &eventWhenFalseDef_, newEventWhenFalse, (evType_ == "common") ? EVENT_GENERIC : EVENT_PMDG, (evType_ == "common") ? EVT::GENERIC : EVT::PMDG_CLICK },
    };
