...
void DialAction::UpdateVariablesAndEvents(const nlohmann::json& payload) {
    ...
    evType_ = settings.value("type", "common");
    ...
    eventBindings_ = {
        { &toggleEventDef_, newEvent, (evType_ == "common") ? EVENT_GENERIC : EVENT_PMDG, (evType_ == "common") ? EVT::GENERIC : EVT::PMDG_CLICK },
        { &incEventDef_, newIncEvent, (evType_ == "common") ? EVENT_GENERIC : EVENT_PMDG, (evType_ == "common") ? EVT::GENERIC : EVT::PMDG_SCROLL_UP },
        { &decEventDef_, newDecEvent, (evType_ == "common") ? EVENT_GENERIC : EVENT_PMDG, (evType_ == "common") ? EVT::GENERIC : EVT::PMDG_SCROLL_DOWN },
        { &inc2EventDef_, newInc2Event, (evType_ == "common") ? EVENT_GENERIC : EVENT_PMDG, (evType_ == "common") ? EVT::GENERIC : EVT::PMDG_SCROLL_UP },
        { &dec2EventDef_, newDec2Event, (evType_ == "common") ? EVENT_GENERIC : EVENT_PMDG, (evType_ == "common") ? EVT::GENERIC : EVT::PMDG_SCROLL_DOWN },
    };
...
void DialAction::SendToPI(const nlohmann::json& payload) {
    ...
    if (evType_ == "pmdg") {
        for (const auto& evt : GetPmdgEvents()) {
